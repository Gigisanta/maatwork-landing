      ...
      <div className="mx-auto max-w-[1320px] px-5 md:px-8 py-16">
        <div className="grid md:grid-cols-[1.5fr_repeat(4,1fr)] gap-10 md:gap-8">
          <div>
            ...
            <p className="mt-3 text-[14px] text-[#a78bfa]/85 max-w-[300px] leading-[1.55]">
            ...
            <form className="mt-6 max-w-[300px]" onSubmit={(e) => e.preventDefault()}>
              <label className="text-[12px] text-[#a78bfa]/80 uppercase tracking-[0.18em] font-semibold">
                Tips para tu local
              </label>
              <div className="mt-2 flex gap-2">
                <input
                  ...
                  className="flex-1 h-10 px-3 rounded-md bg-white/[0.04] border border-white/10 text-[13px] text-white placeholder:text-[#a78bfa]/50 focus:outline-none focus:border-[#7c3aed]/50 transition-colors"
                />
                <button
                  type="submit"
                  className="h-10 px-4 rounded-md bg-[#7c3aed] hover:bg-[#8b44f4] text-white font-semibold text-[13px] transition-colors"
                >
                  Unirme
                </button>
              </div>
              <p className="mt-2 text-[10.5px] text-[#a78bfa]/65">
        ...
        <div className="mt-12 pt-6 border-t border-white/[0.06] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4 text-[12.5px] text-[#a78bfa]/75">
