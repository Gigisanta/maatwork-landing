...
/**
 * Navbar — transparente en hero, solid con blur al scrollear.
 */
  ...
  return (
    <header
      className={[
        ...
        scrolled
          ? "bg-[#0f0520]/85 backdrop-blur-md border-b border-white/[0.06]"
          : "bg-transparent",
      ].join(" ")}
    >
      <nav className="mx-auto max-w-[1200px] px-6 md:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="cta-whatsapp hidden md:inline-flex items-center gap-2 text-white font-semibold text-[14px] h-10 px-4 rounded-full"
            target="_blank"
      ...
      {open && (
        <div className="md:hidden border-t border-white/[0.06] bg-[#0f0520]/95 backdrop-blur">
