          ...
          <div className="reveal">
            <div className="featured-border rounded-2xl p-8 md:p-10 hover-scale">
              <div className="flex items-baseline justify-between">
                <div>
                  <div className="text-[12.5px] uppercase tracking-[0.18em] text-[#a78bfa] flex items-center gap-2">
                    Plan único
                    <span className="inline-flex items-center gap-1.5 rounded-full bg-[#25D366]/15 border border-[#25D366]/30 text-[#25D366] text-[10.5px] font-semibold px-2.5 py-0.5">
            ...
            <div className="card p-6 md:p-8 h-full">
              ...
              <div className="mt-8 space-y-3">
                <div className="flex items-center justify-between text-[13px]">
                  <span className="text-[#a78bfa]/80">Hoy perdés</span>
                  <span className="text-white font-semibold tabular-nums">
                    ${new Intl.NumberFormat("es-AR").format(costPerMonthARS)}/mes
                  </span>
                </div>
                <div className="flex items-center justify-between text-[13px]">
                  <span className="text-[#a78bfa]/80">Plan MaatWork</span>
                  <span className="text-white font-semibold tabular-nums">
